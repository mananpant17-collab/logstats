...
export default function Analytics() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-gray-300 pb-24 font-sans">
      
      {/* HEADER */}
      <div className="px-6 py-4 flex justify-between items-center border-b border-gray-800">
        <h1 className="font-serif text-xl tracking-[0.2em] text-gray-100 uppercase">Log Stats</h1>
        <div className="text-[10px] tracking-widest text-gray-500 uppercase flex items-center gap-4">
          <span>live · {format(new Date(), 'HH:mm:ss')}</span>
        </div>
      </div>
