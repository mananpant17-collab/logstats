  ...
  const chart = (data: any[], key: string, color: string, domain?: [number, number]) => (
    <ResponsiveContainer width="100%" height="100%">
      <LineChart data={data} margin={{ top: 15, right: 8, left: -20, bottom: 0 }}>
        <CartesianGrid stroke="#334155" strokeOpacity={0.35} /><XAxis dataKey="date" stroke="#64748b" fontSize={9} tickLine={false} axisLine={false} tickMargin={10} minTickGap={30} /><YAxis domain={domain} allowDecimals={key !== 'weight'} stroke="#64748b" fontSize={9} tickLine={false} axisLine={false} tickMargin={8} /><Tooltip content={<ChartTooltip />} /><Line type="monotone" dataKey={key} stroke={color} strokeWidth={1.5} dot={false} activeDot={{ r: 3, fill: color }} />
      </LineChart>
    </ResponsiveContainer>
  );
